/**
 * Theme configuration and color gradients
 */
...
/**
 * Floating blob colors by section
 */
export const blobColors = {
    ...
    collaborate: ['bg-purple-200/20', 'bg-pink-200/20'],
};

/**
 * Accent gradients for dividers and highlights
 */
export const accentGradients = {
    ...
    blueCyanTeal: 'from-blue-600 via-cyan-600 to-teal-600',
};
